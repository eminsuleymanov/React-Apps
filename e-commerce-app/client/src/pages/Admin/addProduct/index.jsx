...
const AddProduct = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit:(values)=> {
     const newProduct = new Product(values.name,values.salePrice,values.costPrice,values.imgSrc,values.discountPercentage,values.description,values.categoryId,values.stock)
